 ...
 *
 */
public class SMSHandler_Send
{

	public static void sendSMS(String pMobile, String pHeading , String pMessage) throws Exception
	{
		System.out.println("************************** Sending sms ************************** " );
		SMSHandler_Send sender = new SMSHandler_Send();
		initialize(SMS_OUT_PORT, SMS_OUT_BAUD_RATE, "", "");
			...
			String phoneModelNo) throws Exception
	{
		...
		SMSHandler_Send lSMSHandler = new SMSHandler_Send();
		
		InboundNotification inboundNotification = 
			lSMSHandler.new InboundNotification();
